...
export const CARD_SETS_SUBSETS = {
  "Genetic Apex": ["Charizard", "Pikachu", "Mewtwo"],
  "Space-Time Smackdown": ["Dialga", "Palkia"],
  "Celestial Guardians": ["Lunala", "Solgaleo"],
};
 ...
 */
export const calculateDesirabilityFromRarity = (
  ...
  switch (rarityValue) {
    case 1:
      return 1; // Common - 1 Diamonds
    case 2:
      return 1; // Uncommon - 2 Diamonds
    case 3:
      return 2; // Rare - 3 Diamonds
    case 4:
      return 3; // EX- 4 Diamonds
    case 5:
      return 3; // 1 Star
    case 6:
      return 4; // Super Rare - 2 Stars
    case 7:
      return 4; // Super Art Rare - Rainbow 2 Star
    default:
...
export const processSavedPack = (
  ...
  for (const cardStr of pack.cards) {
    ...
    const imageUrl = findCardInPokedex(
      cardName,
      setBaseName,
      setName,
      rarity,
    ...
    // Count cards with 2 stars (☆☆ or ★★) as top cards
